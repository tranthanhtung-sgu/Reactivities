        ...
        <div className="d-flex">
          ...
          <div style={{ marginLeft: "10px" }}>
            ...
            <a href="/" className="d-block text-muted">
              <small style={{ marginRight: 10 }}>10h</small>
              <i className="fas fa-globe-africa"></i>
            </a>
          </div>
        </div>
        <p className="mt-3">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates architecto sapiente ut porro eum officiis
          magni beatae vel nostrum rerum at provident temporibus, tempore quam reiciendis earum, sunt quae quisquam.
        </p>
      </div>
      <img src="https://res.cloudinary.com/images-store/image/upload/v1622545740/idutyugjcvywsz7qstv6.jpg" alt="" />
      <div className="card-body">
            ...
            <div className="comment__content">
              <div className="comment__others" style={{ marginLeft: "10px", background: "rgb(240,242,245)" }}>
                ...
                <p className="pt-1 pb-2">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore reiciendis ea ipsam cumque repellat
                  quibusdam, explicabo, dolor error temporibus rerum assumenda rem dicta placeat, exercitationem ipsum
                  animi enim porro! Asperiores. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore
                  reiciendis ea ipsam cumque repellat quibusdam, explicabo, dolor error temporibus rerum assumenda rem
                  dicta placeat, exercitationem ipsum animi enim porro! Asperiores. Lorem ipsum dolor, sit amet
                  consectetur adipisicing elit. Tempore reiciendis ea ipsam cumque repellat quibusdam, explicabo, dolor
                  error temporibus rerum assumenda rem dicta placeat, exercitationem ipsum animi enim porro! Asperiores.
                </p>
              </div>
